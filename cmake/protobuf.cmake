...
elseif(gRPC_PROTOBUF_PROVIDER STREQUAL "package")
  ...
  find_package(Protobuf REQUIRED HINTS ${QNX_Protobuf} NO_DEFAULT_PATH CONFIG)
    ...
    if(TARGET protobuf::protoc)
      ...
      if(CMAKE_CROSSCOMPILING)
        if (QNX)
          ...
          find_program(_gRPC_PROTOBUF_PROTOC_EXECUTABLE protoc HINTS ${HOST_PROTOC_PATH} NO_CMAKE_FIND_ROOT_PATH)
          set(CMAKE_FIND_DEBUG_MODE FALSE)
          # message(FATAL_ERROR ${_gRPC_PROTOBUF_PROTOC_EXECUTABLE})
        else()
          find_program(_gRPC_PROTOBUF_PROTOC_EXECUTABLE protoc)
        endif() # QNX
      else()
